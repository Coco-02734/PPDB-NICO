    ...
    <div class="row">
        <div class="col-lg-12 mb-4">
            ...
            <div class="table-responsive p-3">
                <a href="<?= base_url('user_admin/cetak_siswa_konfirmasi'); ?>" class="btn btn-warning">Cetak Data </a>
                <br>
                <br>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($siswa as $m) : ?>
                            <tr>
                                ...
                                <td>000<?= $m['id']; ?></td>
                                <td>
                                    <a href="<?= base_url('user_admin/halaman_verify_data_siswa/' .  $m['nis_siswa']) ?>" class="badge badge-warning"> Lihat Data </a>
